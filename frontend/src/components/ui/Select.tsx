    ...
    <div className={cn('w-full', className)}>
      ...
      <button
        ...
        className={cn(
          ...
          error ? 'border-error-500' : open ? 'border-primary-500 ring-2 ring-primary-100 bg-white' : 'border-neutral-200',
        )}
      >
        ...
        >
          ...
          <div className="max-h-60 overflow-y-auto py-1">
            {loading ? (
              ...
              <div className="px-3 py-4 text-center text-sm text-neutral-400">No options found</div>
            ) : (
              filteredOptions.map((option) => (
                ...
                >
                  <div>
                    <p className={cn('text-sm', option.value === value ? 'text-primary-700 font-medium' : 'text-neutral-700')}>
                      {option.label}
                    </p>
                    {option.sublabel && (
                  ...
                  {option.value === value && <Check className="w-4 h-4 text-primary-600 shrink-0" />}
                </button>
              ))
            )}
          </div>
